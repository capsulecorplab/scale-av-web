...
image::./assets/Mothership-Control.png[Screenshot of Mothership Control]
...
image::./assets/LCARS-II.png[Screenshot of Room Window]
...
image::./assets/Camera-Controls.png[Screenshot of Camera Controls,width=80%,height=80%]
...
HDMI Input
image::./assets/HDMI-input.png[Screenshot of HDMI Input Menu]
...
Select Scene
image::./assets/Select-Scene.png[Screenshot of Select Scene Menu]
